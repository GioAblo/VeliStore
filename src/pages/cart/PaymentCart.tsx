  ...
  return (
    ...
    <>
                                                    ...
                                                    <div className='mt-[16px]'>
                                                        ...
                                                        <NavLink to="contactinfo" className='flex items-center justify-center h-[48px] rounded-xl mt-[20px] w-full bg-[#B4D984]'>
                                                            <div className="text-[12px]  font-bold" >Checkout</div>
                                                        </NavLink>
                                                    </div>
    </>
  )
