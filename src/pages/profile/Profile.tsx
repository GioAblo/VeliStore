  ...
  return (
    <div className='relative mx-4 my-5 md:mt-[120px] max-w-[1232px] lg:mx-[64px] xl:mx-auto xl:w-full xl:px-[32px]'>
        <div className='md:hidden'>
            <div className='font-bold text-[20px]'>HELLO, {userInfo != null ? userInfo.first_name +" " + userInfo.last_name : "..."}</div>
        ...
        <div className='hidden md:flex gap-5 items-center border-b pb-4'>
          ...
          <div className='font-bold text-[20px] lg:text-[24px]'>HELLO, {userInfo != null ? userInfo.first_name +" " + userInfo.last_name : "..."}</div>
        </div>
