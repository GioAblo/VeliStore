...
import { signup, signupFormInterface } from '@/services/api/auth';
import React, { useEffect, useState } from 'react'
import { Link, useLocation, useNavigate } from 'react-router-dom';
import Swal from 'sweetalert2';

const SignUp = ({setIsSign}) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const userRegisteredSuccessfully = await signup(formData)
        ...
        useEffect(() => {
            ...
            const check = () => {
                ...
                if (location.pathname === "/signup" && window.innerWidth > 1024) {
                navigate("/");
                }
            };
    ...
    return (
        <>
                <div className='pt-4 px-4 pb-20 md:hidden'>
                    <div>
                    ...
                    <div className='flex  my-5 '>
                        <Link to="/signin" className='w-full text-[11px] font-semibold  text-center py-3 border-b'>Sign In</Link>
                        <Link to="/signup" className='w-full text-[11px] border-[#B4D984]  font-bold  text-center py-3 border-b'>Sign Up</Link>
                    </div>
                    <div className=''>
                        ...
                        <form onSubmit={handleSubmit} className='space-y-6'>
                            ...
                            <div className='flex focus-within:border-[#6D942E] group  border rounded-lg relative h-[48px]'>
                                <label className='text-[10px] transition-colors  group-focus-within:text-[#6D942E] absolute text-[#717785] top-2 left-3' htmlFor="" >First Name*</label>
                                <input
                                    type="text"
                                    id="first_name"
                                    name="first_name"
                            ...
                            <div className='flex focus-within:border-[#6D942E] group  border rounded-lg relative h-[48px]'>
                                <label className='text-[10px] transition-colors  group-focus-within:text-[#6D942E] absolute text-[#717785] top-2 left-3' htmlFor="" >Last Name*</label>
                                <input
                                    type="text"
                                    id="last_name"
                                    name="last_name"
                            ...
                            <div className='flex focus-within:border-[#6D942E] group  border rounded-lg relative h-[48px]'>
                                <label className='text-[10px] transition-colors  group-focus-within:text-[#6D942E] absolute text-[#717785] top-2 left-3' htmlFor="" >Phone Number*</label>
                                <input
                                   type="number"
                                    id="phone-number"
                                    name="phone_number"
                            ...
                            <Button type="submit" className='w-full rounded-[10px] bg-black h-[48px]'>Create account</Button>
                        </form>
                ...
                <div className='hidden  md:block md:mt-[140px] md:pb-10 lg:pb-0 lg:mt-0 mx-auto md:max-w-[500px] lg:max-w-auto'>
                    <div className='text-[24px] font-bold text-center'>Create account</div>
            
                    <div className='flex  my-6 gap-2 '>
                            <div onClick={() => setIsSign(false)} className='w-full hidden lg:block cursor-pointer text-[14px] font-bold  text-center py-3 border-b-2'>Sign In</div>
                            <Link to="/signin" className='w-full lg:hidden cursor-pointer text-[14px] font-bold  text-center py-3 border-b-2'>Sign In</Link>
                            <div   className='w-full text-[14px] border-black cursor-pointer font-semibold text-center py-3 border-b-2'>Sign Up</div>
                    </div>                
                    ...
                    <div className=''>
                        ...
                        <form onSubmit={handleSubmit} className='space-y-6'>
                            ...
                            <div className='flex focus-within:border-[#6D942E] group  lg:w-[440px] h-[55px] border rounded-lg relative '>
                                <label className='text-[13px] transition-colors  group-focus-within:text-[#6D942E] absolute text-[#717785] top-2 left-3' htmlFor="" >First Name*</label>
                                <input
                                    type="text"
                                    id="first_name"
                                    name="first_name"
                            ...
                            <div className='flex focus-within:border-[#6D942E] group  border rounded-lg relative lg:w-[440px] h-[55px]'>
                                <label className='text-[13px] transition-colors  group-focus-within:text-[#6D942E] absolute text-[#717785] top-2 left-3' htmlFor="" >Last Name*</label>
                                <input
                                    type="text"
                                    id="last_name"
                                    name="last_name"
                            ...
                            <div className='flex focus-within:border-[#6D942E] group  border rounded-lg relative lg:w-[440px] h-[55px]'>
                                <label className='text-[13px] transition-colors  group-focus-within:text-[#6D942E] absolute text-[#717785] top-2 left-3' htmlFor="" >Phone Number*</label>
                                <input
                                   type="number"
                                    id="phone-number"
                                    name="phone_number"
                            ...
                            <Button type="submit" className='w-full rounded-[10px] bg-black h-[55px]'>Create account</Button>
                        </form>
